...
class ShopifyPageURL{
    ...
    communityUserProfilePrefix: HttpUrl = 'https://community.shopify.com/c/user/viewprofilepage/user-id/'
    ...
    communityLanguageSuffixes: ShopifyCommunityLanguageUrlSuffix = {
        ...
        portuguese: "/c/comunidade-da-shopify-pt-br/ct-p/pt-br?profile.language=pt-br",
        chineseSimplified: "/c/shopify-community-zh-cn/ct-p/zh-cn?profile.language=zh-CN"
    }

    constructor(public businessIdentifiers: BusinessProfile){
    ...
    get appLandingPage(): URL{
        return this.normalizeUrl(this.appsMarketPlace, this.businessIdentifiers.appUrlId??"")
    }
    get appPartnerLandingPage(): URL{
        return this.normalizeUrl(this.appPartnerPrefix, this.businessIdentifiers.partnerUrlId??"")
    }
    get appReviewsDefaultPage(): URL{
        return this.normalizeUrl(this.appLandingPage, "reviews")
    }
    get communityLandingPage():URL{
        return this.normalizeUrl(this.communityPrefix, this.communityLanguageSuffixes[
    ...
    get communityUserProfile():URL{
        ...
        }else{return this.communityLandingPage}
    }
    get appCategoryPage(): URL{
        return this.normalizeUrl(this.appCategoryPrefix, this.businessIdentifiers.categoryUrlId??"")
    }
    addPageParam(baseURL: URL, pageNum: number=1, pageField: string = "page"): URL{
    ...
    reviewPaginatedURL(page: number): URL{
        return this.addPageParam(
            this.appReviewsDefaultPage, page
        )
    }
    appCategoryPaginatedURL(page: number): URL{
        return this.addPageParam(
            this.appCategoryPage, page
        )
    }
}
