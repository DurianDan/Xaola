...
export type Tables<
  PublicTableNameOrOptions extends
    | keyof (Database["scraped"]["Tables"] & Database["scraped"]["Views"])
...
> = PublicTableNameOrOptions extends { schema: keyof Database }
  ? (Database[PublicTableNameOrOptions["schema"]]["Tables"] &
    ...
    ? R
    : never
  : PublicTableNameOrOptions extends keyof (Database["scraped"]["Tables"] &
      Database["scraped"]["Views"])
  ? (Database["scraped"]["Tables"] &
      Database["scraped"]["Views"])[PublicTableNameOrOptions] extends {
      Row: infer R
    }
    ? R
    : never
...
> = PublicTableNameOrOptions extends { schema: keyof Database }
  ? Database[PublicTableNameOrOptions["schema"]]["Tables"][TableName] extends {
    ...
    : never
  : PublicTableNameOrOptions extends keyof Database["scraped"]["Tables"]
  ? Database["scraped"]["Tables"][PublicTableNameOrOptions] extends {
      Insert: infer I
    }
    ? I
    : never
...
> = PublicEnumNameOrOptions extends { schema: keyof Database }
  ...
  : PublicEnumNameOrOptions extends keyof Database["scraped"]["Enums"]
  ? Database["scraped"]["Enums"][PublicEnumNameOrOptions]
  : never
